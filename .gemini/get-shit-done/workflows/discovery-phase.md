...
See C:/FTS/MED-AI/DemoRepo/.gemini/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using C:/FTS/MED-AI/DemoRepo/.gemini/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using C:/FTS/MED-AI/DemoRepo/.gemini/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from C:/FTS/MED-AI/DemoRepo/.gemini/get-shit-done/templates/discovery.md
...
Use C:/FTS/MED-AI/DemoRepo/.gemini/get-shit-done/templates/discovery.md.
