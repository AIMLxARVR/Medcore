...
<required_reading>
@C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/references/ai-frameworks.md
@C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/FTS/MED-AI/DemoRepo/.kilo/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/FTS/MED-AI/DemoRepo/.kilo/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/FTS/MED-AI/DemoRepo/.kilo/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/FTS/MED-AI/DemoRepo/.kilo/agents/gsd-eval-planner.md for instructions.
