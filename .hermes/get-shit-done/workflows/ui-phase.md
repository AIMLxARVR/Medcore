...
```markdown
Read C:/FTS/MED-AI/DemoRepo/.hermes/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/FTS/MED-AI/DemoRepo/.hermes/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/FTS/MED-AI/DemoRepo/.hermes/agents/gsd-ui-checker.md for instructions.
