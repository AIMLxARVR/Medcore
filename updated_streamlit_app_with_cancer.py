...
# Import prescription analysis module
...
<style>
    ...
    /* Prescription analysis specific styling */
    .prescription-header {
...
def setup_tesseract_path():
    ...
    try:
        ...
        # Linux usually has tesseract in PATH, so no setup needed
        
    except ImportError:
        # pytesseract not installed, skip setup
        pass
    except Exception as e:
        logging.warning(f"Tesseract setup failed: {e}")
        ...
        <div class="comparison-table">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr style="background: #f8f9fa;">
                        <td style="padding: 10px; border: 1px solid #dee2e6;">প্রেসক্রিপশন বিশ্লেষণ</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">✅ ক্যান্সার ওষুধ বিশেষজ্ঞতা</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">✅ সাধারণ ওষুধ বিশ্লেষণ</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="comparison-table">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr style="background: #f8f9fa;">
                        <td style="padding: 10px; border: 1px soli                    <tr style="background: #f8f9fa;">
                        <td style="padding: 10px; border: 1px solid #dee2e6;">Prescription Analysis</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">✅ Cancer Drug Expertise</td>
                        <td style="padding: 10px; border: 1px solid #dee2e6;">✅ General Drug Analysis</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    with st.sidebar:
        ...
        if st.session_state.app_mode == 'cancer':
            ...
            if st.session_state.language == "Bengali":
                st.markdown("""
                <div style="background: #f8f9fa; padding: 15px; border-radius: 10px;">
                    <h4>📊 সাধারণ AI পরিসংখ্যান</h4>
                    <ul style="margin: 10px 0; padding-left: 20px; font-size: 0.9em;">
                        <li>২০০+ স্বাস্থ্য সমস্যা</li>
                        <li>ফলো-আপ প্রশ্ন সিস্টেম</li>
                        <li>মাল্টিমোডাল বিশ্লেষণ</li>
                        <li>বহুভাষিক সহায়তা</li>
                        <li>প্রেসক্রিপশন OCR</li>
                    </ul>
                </div>
                ...
                st.markdown("""
                <div style="background: #f8f9fa; padding: 15px; border-radius: 10px;">
                    <h4>📊 General AI Statistics</h4>
                    <ul style="margin: 10px 0; padding-left: 20px; font-size: 0.9em;">
                        <li>200+ Health conditions</li>
...
def render_enhanced_cancer_domain_app_with_prescription():
    """Enhanced cancer domain app with prescription analysis"""
    ...
    if selected_language == "Bengali":
        ...
        <div style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); 
                    ...
                    box-shadow: 0 8px 25px rgba(255, 107, 107, 0.3); text-align: center;">
            <h1 style="margin: 0; font-size: 2.5em;">🎯 উন্নত ক্যান্সার AI বিশেষজ্ঞ</h1>
            <p style="margin: 10px 0 0 0; font-size: 1.2em; opacity: 0.9;">
                ব্যবহারকারী-বান্ধব প্রশ্নোত্তর ও প্রেসক্রিপশন বিশ্লেষণ সহ স্মার্ট ক্যান্সার ঝুঁকি মূল্যায়ন
            </p>
        </div>
        """, unsafe_allow_html=True)
    else:
        ...
        <div style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a24 100%); 
            ...
            <p style="margin: 10px 0 0 0; font-size: 1.2em; opacity: 0.9;">
                Smart cancer risk assessment with user-friendly questionnaire & prescription analysis
            </p>
        </div>
        """, unsafe_allow_html=True)
    
    # Main application tabs WITH PRESCRIPTION ANALYSIS
    if selected_language == "Bengali":
        tab1, tab2, tab3, tab4 = st.tabs([
            "🎯 স্মার্ট পরামর্শ",
            "🎤 ভয়েস + ভিশন", 
            "📊 দ্রুত ঝুঁকি চেক",
            "📋 প্রেসক্রিপশন বিশ্লেষণ"  # NEW TAB
        ])
    else:
        tab1, tab2, tab3, tab4 = st.tabs([
            "🎯 Smart Consultation",
            "🎤 Voice + Vision",
            "📊 Risk Check",
            "📋 Prescription Analysis"  # NEW TAB
        ])
    
    # Import cancer consultation functions
    from enhanced_cancer_consultation_system import create_enhanced_cancer_consultation_interface
    from updated_cancer_streamlit_integration import (
        render_enhanced_cancer_voice_vision_interface,
        render_quick_risk_assessment
    )
    ...
    # Tab 4: NEW - Prescription Analysis
    with tab4:
        create_prescription_analysis_interface(selected_language)


def render_general_medical_app_with_prescription():
    """Enhanced version of render_general_medical_app with prescription analysis"""
    ...
    if st.session_state.language == "Bengali":
        ...
        <div class="main-header">
            ...
            <p>ব্যাপক স্বাস্থ্য সহায়তা সব ধরনের চিকিৎসা সমস্যার জন্য - এখন প্রেসক্রিপশন বিশ্লেষণ সহ</p>
        </div>
        """, unsafe_allow_html=True)
    else:
        st.markdown("""
        <div class="main-header">
            <h1>🏥 LABAID GPT</h1>
            <p>Comprehensive health assistance for all medical concerns - now with prescription analysis</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    if st.session_state.language == "Bengali":
        ...
        <div style="background: linear-gradient(135deg, #4ecdc4 0%, #44a08d 100%); 
            ...
            <strong>✨ নতুন বৈশিষ্ট্য যুক্ত:</strong> প্রেসক্রিপশন বিশ্লেষণ, ফলো-আপ প্রশ্ন, বিস্তারিত বিশ্লেষণ এবং ব্যক্তিগত সুপারিশ
        </div>
        """, unsafe_allow_html=True)
    else:
        st.markdown("""
        <div style="background: linear-gradient(135deg, #4ecdc4 0%, #44a08d 100%); 
                    color: white; padding: 15px; border-radius: 10px; margin: 15px 0;">
            <strong>✨ New Features Added:</strong> Prescription Analysis, Follow-up questions, detailed analysis, and personalized recommendations
        </div>
        """, unsafe_allow_html=True)
    
    # Create tabs for different features - NOW WITH PRESCRIPTION ANALYSIS
    if st.session_state.language == "Bengali":
    ...
    # NEW TAB 3: Prescription Analysis
    with tab3:
...
def main():
    ...
    if st.session_state.app_mode == 'selector':
        ...
        render_main_navigation()
        render_general_medical_app_with_prescription()
    ...
    if st.session_state.language == "Bengali":
        ...
        <div style="text-align: center; padding: 20px; color: #666; background: #f8f9fa; 
            ...
            <div style="margin-top: 15px;">
                ...
                <span style="margin: 0 10px;">📋 OCR Analysis</span>
            </div>
            <p style="margin: 15px 0 0 0; font-size: 0.8em; color: #888;">
                Powered by Advanced AI • Version 3.0 • © 2024
            </p>
        </div>
        """, unsafe_allow_html=True)
    else:
