...
```
Agent(
  prompt="Read C:/FTS/MED-AI/DemoRepo/.qwen/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/templates/SECURITY.md`
