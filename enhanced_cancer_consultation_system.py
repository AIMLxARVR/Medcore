...
class EnhancedCancerConsultationSession:
    ...
    def _complete_consultation(self) -> Dict[str, Any]:
        """Complete the consultation and generate dynamic analysis"""
        ...
        try:
            ...
            # Generate dynamic recommendations based on user responses
...
def display_enhanced_consultation_results(consultation: EnhancedCancerConsultationSession, language: str):
    """Display comprehensive consultation results with enhanced features"""
    
    if language == "Bengali":
        st.markdown("""
        <div style="background: linear-gradient(135deg, #4caf50 0%, #45a049 100%); 
                    color: white; padding: 20px; border-radius: 15px; margin-bottom: 20px;">
            <h2 style="margin: 0;">✅ উন্নত পরামর্শ সম্পন্ন</h2>
            <p style="margin: 5px 0 0 0;">আপনার ব্যাপক ও গতিশীল ক্যান্সার ঝুঁকি মূল্যায়ন প্রস্তুত</p>
        </div>
        """, unsafe_allow_html=True)
    else:
        st.markdown("""
        <div style="background: linear-gradient(135deg, #4caf50 0%, #45a049 100%); 
                    color: white; padding: 20px; border-radius: 15px; margin-bottom: 20px;">
            <h2 style="margin: 0;">✅ Enhanced Consultation Complete</h2>
            <p style="margin: 5px 0 0 0;">Your comprehensive & dynamic cancer risk assessment is ready</p>
        </div>
        """, unsafe_allow_html=True)
