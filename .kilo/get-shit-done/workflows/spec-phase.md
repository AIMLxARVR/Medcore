...
```bash
INIT=$(node "C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/templates/spec.md.
