...
```markdown
Read C:/FTS/MED-AI/DemoRepo/.trae/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/FTS/MED-AI/DemoRepo/.trae/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/FTS/MED-AI/DemoRepo/.trae/agents/gsd-ui-checker.md for instructions.
