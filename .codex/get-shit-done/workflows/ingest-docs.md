...
```bash
INIT=$(node "C:/FTS/MED-AI/DemoRepo/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/FTS/MED-AI/DemoRepo/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
