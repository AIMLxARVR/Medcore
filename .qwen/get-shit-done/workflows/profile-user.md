...
Key references:
- @C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/references/ui-brand.md (display patterns)
- @C:/FTS/MED-AI/DemoRepo/.qwen/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/USER-PROFILE.md" "C:/FTS/MED-AI/DemoRepo/.qwen/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/references/user-profiling.md`
...
Reference: @C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global QWEN.md" -- "Add profile to C:/FTS/MED-AI/DemoRepo/.qwen/QWEN.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/FTS/MED-AI/DemoRepo/.qwen/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/FTS/MED-AI/DemoRepo/.qwen/QWEN.md"
...
```bash
BACKUP_PATH="C:/FTS/MED-AI/DemoRepo/.qwen/USER-PROFILE.backup.md"
```
...
Your profile:    C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/FTS/MED-AI/DemoRepo/.qwen/skills/gsd-dev-preferences/SKILL.md
  ✓ QWEN.md section       ./QWEN.md
  ✓ Global QWEN.md        C:/FTS/MED-AI/DemoRepo/.qwen/QWEN.md
```
