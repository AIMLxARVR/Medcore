...
```bash
INIT=$(node "C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/templates/spec.md.
