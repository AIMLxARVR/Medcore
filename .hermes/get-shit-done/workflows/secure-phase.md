...
```
Agent(
  prompt="Read C:/FTS/MED-AI/DemoRepo/.hermes/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/FTS/MED-AI/DemoRepo/.hermes/get-shit-done/templates/SECURITY.md`
