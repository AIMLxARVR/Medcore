...
```
Agent(
  prompt="Read C:/FTS/MED-AI/DemoRepo/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/FTS/MED-AI/DemoRepo/.opencode/get-shit-done/templates/VALIDATION.md`
