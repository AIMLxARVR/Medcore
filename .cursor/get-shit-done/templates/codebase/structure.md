...
- Usage: Reference from command with `@C:/FTS/MED-AI/DemoRepo/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/FTS/MED-AI/DemoRepo/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/FTS/MED-AI/DemoRepo/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
