...
<template>
@C:/FTS/MED-AI/DemoRepo/.hermes/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/FTS/MED-AI/DemoRepo/.hermes/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/FTS/MED-AI/DemoRepo/.hermes/get-shit-done/workflows/transition.md`.
...
- Follow @C:/FTS/MED-AI/DemoRepo/.hermes/get-shit-done/workflows/diagnose-issues.md
