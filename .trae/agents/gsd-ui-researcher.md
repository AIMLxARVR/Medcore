...
Use template from `C:/FTS/MED-AI/DemoRepo/.trae/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/FTS/MED-AI/DemoRepo/.trae/get-shit-done/templates/UI-SPEC.md`
