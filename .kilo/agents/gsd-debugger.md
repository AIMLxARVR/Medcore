...
<required_reading>
@C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/FTS/MED-AI/DemoRepo/.kilo
                  → checks C:/FTS/MED-AI/DemoRepo/.kilo/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done
                  → writes to C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/hooks/
...
@C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/references/common-bug-patterns.md
