...
- @C:/FTS/MED-AI/DemoRepo/.cursor/get-shit-done/workflows/complete-milestone.md (main workflow)
- @C:/FTS/MED-AI/DemoRepo/.cursor/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
