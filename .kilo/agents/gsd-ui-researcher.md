...
Use template from `C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/templates/UI-SPEC.md`
