...
INSTALL_JS_GLOBAL="C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
