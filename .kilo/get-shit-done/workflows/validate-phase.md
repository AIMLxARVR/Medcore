...
```
Agent(
  prompt="Read C:/FTS/MED-AI/DemoRepo/.kilo/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/FTS/MED-AI/DemoRepo/.kilo/get-shit-done/templates/VALIDATION.md`
