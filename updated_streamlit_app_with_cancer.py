...
def render_app_selector():
    ...
    with col1:
        if st.session_state.language == "Bengali":
            if st.button("🎯 ক্যান্সার AI বিশেষজ্ঞ", key="cancer_domain_btn", type="primary", width='stretch'):
            ...
            if st.button("🎯 Cancer AI Specialist", key="cancer_domain_btn", type="primary", width='stretch'):
                st.session_state.app_mode = 'cancer'
                st.rerun()
    ...
    with col2:
        if st.session_state.language == "Bengali":
            if st.button("🏥 সাধারণ চিকিৎসা AI", key="general_domain_btn", type="secondary", width='stretch'):
            ...
            if st.button("🏥 General Medical AI", key="general_domain_btn", type="secondary", width='stretch'):
                st.session_state.app_mode = 'general'
                st.rerun()
...
def render_main_navigation():
    ...
    with st.sidebar:
        ...
        if st.session_state.language == "Bengali":
            if st.button("🏠 মূল মেনুতে ফিরুন", width='stretch'):
                st.session_state.app_mode = 'selector'
                st.rerun()
        else:
            if st.button("🏠 Back to Main Menu", width='stretch'):
                st.session_state.app_mode = 'selector'
                st.rerun()
...
def render_basic_medical_imaging_interface(lang_code):
    ...
    if lang_code == "bn":
        ...
        if uploaded_file:
            st.image(uploaded_file, caption="আপলোড করা মেডিকেল ইমেজ", width='stretch')
        ...
        if uploaded_file:
            st.image(uploaded_file, caption="Uploaded Medical Image", width='stretch')
...
def render_voice_image_interface(lang_code):
    ...
    if audio_file or image_file:
        if st.session_state.language == "Bengali":
            if st.button("🚀 বিশ্লেষণ শুরু করুন", type="primary", width='stretch'):
