...
<required_reading>
@C:/FTS/MED-AI/DemoRepo/.codex/get-shit-done/references/user-story-template.md
@C:/FTS/MED-AI/DemoRepo/.codex/get-shit-done/references/spidr-splitting.md
@C:/FTS/MED-AI/DemoRepo/.codex/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/FTS/MED-AI/DemoRepo/.codex/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/FTS/MED-AI/DemoRepo/.codex/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/FTS/MED-AI/DemoRepo/.codex/get-shit-done/references/spidr-splitting.md`. Briefly:
