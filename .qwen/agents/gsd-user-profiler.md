...
<reference>
@C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/FTS/MED-AI/DemoRepo/.qwen/get-shit-done/references/user-profiling.md` to load:
