...
Reference full template: `C:/FTS/MED-AI/DemoRepo/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/FTS/MED-AI/DemoRepo/.gemini/get-shit-done/templates/state.md`.
